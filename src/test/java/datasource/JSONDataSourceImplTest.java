...
import abstractions.JSONConverter;
import datasource.conversions.JSONConverterImpl;
import datasource.states.JSONDataSourceClosedFileState;
import datasource.states.JSONDataSourceOpenedFileState;
...
class JSONDataSourceImplTest {
    ...
    public void dataSource_Nested_Search_Addresses_ShouldReturn_AList() {
        ...
        List<Entry<String, Object>> expected = new ArrayList<>();
    ...
    public void dataSource_Updating_Address_ShouldUpdate_Addresses() {
        ...
        assertTrue(search.get(0) instanceof Entry<?, ?>);
