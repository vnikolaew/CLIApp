...
public class HelpCommand extends CLIQuery<String> {
    ...
    protected QueryResult<String> executeCore() {
        ...
        info.append("The following com.vnikolaev.commands are supported:")
                .append(newLine);
        ...
        info.append(formatLine("search", new String[] { "<searchterm>" }, "com.vnikolaev.queries a given key in the currently opened file"));
